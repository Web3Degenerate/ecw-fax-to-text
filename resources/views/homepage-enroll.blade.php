      ...
      <div class="row align-items-center">
        ...
        {{-- LEFT COLUMN --}}
          <div class="col-lg-7 py-3 py-md-5">
                  ...
                  <div class="form-group">
                        <label for="provider-register" class="text-muted mb-1"><small>Provider</small></label>
                        ...
                        <select name="provider" id="provider-register" class="form-control">
                          <option value="0" {{ old('provider') == 0 ? 'selected' : '' }}>Select A Provider</option>
                          <option value="1" {{ old('provider') == 1 ? 'selected' : '' }}>Vernice Bates, M.D.</option>
                          <option value="2" {{ old('provider') == 2 ? 'selected' : '' }}>Dr. Ajtai, M.D.</option>
                          <option value="3" {{ old('provider') == 3 ? 'selected' : '' }}>Dr. Mechtler, M.D.</option>
                        </select>
                        @error('provider')
                          <p class="m-0 small alert alert-danger shadow-sm">{{$message}}</p>
                        @enderror
